        ...
        Div(
            ...
            Div(
                ...
                Div(
                    ...
                    Div(id="pigment-shelf-list", cls="pigment-shelf-list"),
                    id="pigment-shelf",
                    cls="pigment-shelf",
                    role="region",
                    aria_label="Pigments in selected slice",
                    hidden=True,
                ),
                        ...
                        Div(
                            ...
                            Div(
                                Button(
                                    "Close",
                                    type="button",
                                    id="pigment-popover-close",
                                    cls="pigment-popover-close",
                                ),
                                P(id="pigment-popover-title", cls="pigment-popover-title"),
                                Div(id="pigment-popover-list", cls="pigment-popover-list"),
                                id="pigment-popover",
                                cls="pigment-popover",
                                role="dialog",
                                aria_label="Pigments at this hue",
                                hidden=True,
                            ),
                            Button(
                                Span(
